...
elgatocontrolcenter)
    ...
    type="zip"
    downloadURL="https://edge.elgato.com/egc/macos/eccm/1.9/ElgatoControlCenter-1.9.20829.app.zip"
    appNewVersion=""
    expectedTeamID="Y93VXCB8Q5"
    ;;elgatostreamdeck)
...
elgatowavelink)
    ...
    type="dmg"
    downloadURL="https://edge.elgato.com/egc/macos/ewlm/release/ElgatoWaveLink-3.2.2.2896.dmg"
    appNewVersion=""
    expectedTeamID="Y93VXCB8Q5"
    ;;emacs)
    name="Emacs"
...
pinta)
    name="Pinta"
    type="dmg"
    downloadURL="$(downloadURLFromGit PintaProject Pinta)"
    appNewVersion="$(versionFromGit PintaProject Pinta)"
